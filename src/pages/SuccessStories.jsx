...
const SuccessStories = () => {
    ...
    return (
        <Container className="text-center success-stories-container">
            <div className="ms-5">
            ...
            <Row className="success-stories-row mt-4 g-3 justify-content-center" style={{ marginTop: '20px'}}>
                {Object.keys(peopleData).map((key) => {
                    const person = peopleData[key];
                    return (
                    <Col lg={2} md={4} sm={6} xs={8} className="success-stories-column" key={person.id}>
